...
<head>
    ...
    <script type="text/javascript"
            src="{$tablesorter_path}js/jquery.tablesorter.widgets.js"></script>
    <script type="text/javascript"
            src="{$tablesorter_path}addons/pager/jquery.tablesorter.pager.js"></script>
    ...
    <script type="text/javascript"
            src="{$jqplot_path}dist/plugins/jqplot.categoryAxisRenderer.js"></script>
    <script type="text/javascript"
            src="{$jqplot_path}dist/plugins/jqplot.canvasTextRenderer.js"></script>
    <script type="text/javascript"
            src="{$jqplot_path}dist/plugins/jqplot.canvasAxisTickRenderer.js"></script>
