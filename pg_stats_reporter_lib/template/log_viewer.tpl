...
<head>
    ...
    <script type="text/javascript"
            src="{$tablesorter_path}js/widgets/widget-columnSelector.js"></script>
                ...
                <form id="search_form">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="form_input">
                                <input type="text" name="username" size="20" maxlength="64"
                                       autocomplete="off">
                            </td>
                            <td class="form_label">
                            ...
                            <td class="form_input">
                                <input type="text" name="database" size="20" maxlength="64"
                                       autocomplete="off">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="form_input" colspan="5">
                                <input type="text" name="message" size="80" maxlength="100"
                                       autocomplete="off">
                            </td>
                        </tr>
                        </tbody>
